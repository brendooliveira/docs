---
title: 'Webhooks'
description: 'Configure e receba notificações em tempo real da AobaPay'
icon: 'webhook'
---
...
<Steps>
  <Step title="Acesse a seção de Webhooks">
    <img
      ...
      alt="Interface da plataforma AobaPay mostrando a seção de webhooks"
    />
...
<Card title="Precisa de ajuda?" icon="headset" color="#25c2a0">
  Nossa equipe está disponível para auxiliar na implementação de webhooks. Entre em contato pelo e-mail <Icon icon="envelope" type="solid"/> contato@aobapay.com
</Card>