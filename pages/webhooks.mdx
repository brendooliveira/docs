...
Webhooks permitem que sua aplicação receba notificações em tempo real sobre eventos importantes da Cpay.
...
```
https://meusite.com/webhook/cpay?webhookSecret=seu_secret_aqui
```
...
```json
{
  "data": {
    "transaction": {
      ...
      "status": "COMPLETE",
      "devMode": false,
      "receiptUrl": "https://cpay.com/receipt/tran_123456",
      "kind": "WITHDRAW",
      "amount": 5000,
      "platformFee": 80,
...
```json
{
  "data": {
    "transaction": {
      ...
      "status": "CANCELLED",
      "devMode": false,
      "receiptUrl": "https://cpay.com/receipt/tran_789012",
      "kind": "WITHDRAW",
      "amount": 3000,
      "platformFee": 0,
...
<Card title="Precisa de ajuda?" icon="headset" color="#25c2a0">
  Nossa equipe está disponível para auxiliar na implementação de webhooks. Entre em contato pelo e-mail <Icon icon="envelope" type="solid"/> ajuda@cpay.com
</Card>