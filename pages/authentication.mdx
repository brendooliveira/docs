...
<Tip>  
**Chave de API**: é sua credencial de acesso à Cpay.  
...
No dashboard da Cpay você pode:
...
- A equipe da Cpay **nunca solicitará** suas credenciais  
...
<Steps>  
  <Step title="Acesse Integrações no Dashboard">  
    <img  
      ...
      alt="Tela da Cpay mostrando botão de criação de chave"  
    />  
...
O mesmo endpoint (`https://api.cpay.app.br`) é usado para **produção** e **desenvolvimento**.  
